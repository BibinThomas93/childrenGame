function Game() {
    ...
    this.PlaySpriteCtr = new PIXI.Container();
    ...
    this.texturePig = PIXI.Texture.fromImage('images/dog.png');
    this.pigSprite = new PIXI.Sprite(this.texturePig);

    this.pigSprite1 = new PIXI.Sprite(PIXI.Texture.fromImage('images/pig.png'));
...
Game.prototype = {
    ...
    prepareStage: function(self) {
      ...
      // for (var i = 0; i < 5; i++) {
      //
      //     a[i] = new PIXI.Sprite(PIXI.Texture.fromImage("images/" + i + ".png"));
      //     // a[i].interactive = false;
      //     // a[i].accessible = false;
      //     a[i].visible = false;
      //
      //
      // }
        ...
        self.scale.set(.5);
        self.name.position.set(350,400);
    ...
    interAction: function() {
        ...
        function arrowInteraction() {
            ...
            parent.dialogueText.position.set(340,85);
            parent.dialogueBox.position.set(300,50);
    ...
    prepareLevelsBackground: function(l) {
      ...
      this.levelText = new PIXI.Text("ഘട്ടങ്ങൾ", {
          font: "bold 56px Chilanka",
          fill: "orange"
      });
        ...
        this.pigSprite1.position.set(this.marginLeft + 362, this.marginTop + 175);
        ...
        this.pigSprite1.interactive = true;
        this.pigSprite1.buttonMode = true;
        this.pigSprite1.accessible = true;
    ...
    InteractLevelObject: function() {
        ...
        function levelObjInteraction() {
            ...
            //     tween1.easing = Tween.outElastic;
                ...
                var tween1 = new Tween(inside.pigSprite, "position.y",235, 60, false);
                tween1.easing = Tween.outElastic;
        ...
        function levelObjInteractionOut() {
          ...
          // var tween1 = new Tween(inside.pigSprite, "rotation",-.5, 200, false);
          //     tween1.easing = Tween.outElastic;
          var tween1 = new Tween(inside.pigSprite, "position.y",245, 60, false);
          tween1.easing = Tween.outElastic;
          new ChainedTween([tween1]);
        ...
        this.pigSprite1.click = function() {
    ...
    displayLevels: function() {
        ...
        this.levelsStageCtr.addChild(this.pigSprite1);
    ...
    instructionVideo: function() {
        ...
        function firstInstruction() {
          ...
          parent.handPointerSprite.position.set(parent.marginLeft + 400, parent.marginTop + 160);
              ...
              parent.pig_lSprite.position.set( parent.marginLeft+283,parent.marginTop+260);
              parent.pig_lSprite.scale.set(-.7,.7);
              parent.pig_rSprite.position.set(parent.marginLeft+443,parent.marginTop+260);
              parent.pig_rSprite.scale.set(.7,.7);
              parent.PlayAreaCtr.scale.set(.6,.6);
              parent.PlayAreaCtr.position.set(parent.marginLeft+120,parent.marginTop+150);
    ...
    playArea2: function() {
      ...
      for (var i = 0; i < 4; i++) {
        ...
        this.spriteArray[1] = new PIXI.Sprite(this.playSprite1[select]);
        this.spriteArray[2] = new PIXI.Sprite(this.playSprite2[select]);
        this.spriteArray[3] = new PIXI.Sprite(this.playSprite2[select]);



        var X = [330,470,330,470];
        var Y = [160,160,290,290];
        ...
        for(var i=0;i<4;i++){
          ...
          this.spriteArray[i].anchor.set(.5,.5);
          this.spriteArray[i].scale.x = flip;
          this.spriteArray[i].rotation = rotation;
          this.spriteArray[i].position.set(this.marginLeft+X[pos], this.marginTop+Y[pos]);
  ...
  for(var i=0;i<4;i++){
         this.spriteArray[i].interactive = true;
         this.spriteArray[i].accessible = true;
         this.spriteArray[i].buttonMode = true;
       }

         this.displayPlayArea2();

    },

    displayPlayArea2: function() {

        this.PlayArea2Ctr.addChild(this.level2BaseSprite);
        for(var i=0;i<4;i++){

            this.PlaySpriteCtr.addChild(this.spriteArray[i]);
        }
        parent = this;

        this.spriteArray.click = function(data)
          {
            // this.spriteArray[1].click = function()
            //   {
                alert(parent.spriteArray.indexOf(0))
              // }
        ...
        this.PlayArea2Ctr.addChild(this.PlaySpriteCtr);
    ...
    progressBar: function(x) {
        ...
        if (this.pBcurrentW == 500) {
            ...
            this.graphics.drawRoundedRect(151,461, this.pBcurrentW, 15, 8); // drawRoundedRect(x, y, width, height, radius)
